...
const imageList = [
    ...
    new Image({
        ...
        details: ["./assets/img/tall/details/Boat in the Sunset detail.jpg"],
    ...
    new Image({
        ...
        details: ["./assets/img/tall/details/Dali detail.jpg"],
        size: "tall",
        title: "Dali",
        price: 100,
        dimensions: "60 x 80",
    ...
    new Image({
        ...
        details: ["./assets/img/tall/details/Old House detail.jpg"],
        size: "tall",
        title: "Old House",
        price: 80,
        dimensions: "60 x 100",
    ...
    new Image({
        ...
        details: ["./assets/img/tall/details/Pencil detail.jpg"],
        size: "tall",
        title: "Pencil",
        price: 80,
        dimensions: "60 x 100",
    ...
    new Image({
        ...
        details: ["./assets/img/tall/details/Rose detail.jpg"],
        size: "tall",
        title: "Rose",
        price: 100,
        dimensions: "60 x 100",
    ...
    new Image({
        ...
        details: ["./assets/img/tall/details/Salt Shaker detail.jpg"],
        size: "tall",
        title: "Salt Shaker",
        price: 100,
        dimensions: "60 x 100",
    ...
    new Image({
        ...
        details: ["./assets/img/wide/details/Figs detail.jpg"],
        size: "wide",
        title: "Figs",
        price: 100,
        dimensions: "90 x 60",
    ...
    new Image({
        ...
        details: ["./assets/img/wide/details/River Boat detail.jpg"],
        size: "wide",
        title: "River Boat",
        price: 100,
        dimensions: "90 x 60",
